...
| `java-patterns`       | Java 17+ コーディング規約 + Spring Boot 設計パターン |
...
| `rust-coding-style`       | Rust コーディング規約                                                           | `**/*.rs`            |
| `rust-testing`            | Rust テスト規約                                                                 | `**/*.rs`            |
| `java-coding-style`       | Java コーディング規約                                                           | `**/*.java`          |
| `java-testing`            | Java テスト規約                                                                 | `**/*.java`          |
| `markdown-style`          | Markdown フォーマット規約（テーブル整形等）                                     | `**/*.md`            |
